          ...
          <ul>
            ...
            <li>
              <div>
                ...
                <span><a href="#">麵點</a><a href="#">乾果</a></span>
              </div>
              <i class="iconfont icon-arrow-right-bold"></i>
            </li>
            <li>
              <div>
                <span><a href="#">餐廚</a></span>
                <span><a href="#">數碼產品</a></span>
              </div>
              <i class="iconfont icon-arrow-right-bold"></i>
            </li>
            <li>
              <div>
                <span><a href="#">電器</a></span>
                <span
            ...
            <li>
              <div>
                <span><a href="#">洗護</a></span>
                <span
                  ><a href="#">洗髮</a><a href="#">洗護</a
                  ><a href="#">美妝</a></span
                >
              </div>
              <i class="iconfont icon-arrow-right-bold"></i>
            ...
            <li>
              <div>
                <span><a href="#">服飾</a></span>
                <span><a href="#">女裝</a><a href="#">男裝</a></span>
              </div>
              <i class="iconfont icon-arrow-right-bold"></i>
            </li>
            <li>
              <div>
                <span><a href="#">雜貨</a></span>
                <span><a href="#">戶外</a><a href="#">圖書</a></span>
              </div>
              <i class="iconfont icon-arrow-right-bold"></i>
            </li>
            <li>
